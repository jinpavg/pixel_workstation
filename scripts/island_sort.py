...
ISLAND_COUNT = 15       # number of island blobs to place
MIN_RADIUS = 10         # smallest island radius in pixels
MAX_RADIUS = 130        # largest island radius in pixels
COAST_NOISE = 2.0       # coastline roughness (0 = smooth circles, 1 = very ragged)
